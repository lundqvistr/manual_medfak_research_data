...
- Exemplet undet "Each row corresponds to one observation" är väl exempel på något annat?
  - Ändrat till "Each cell contain only one value"
...
- I "Reproducibility/open data/open science", är "legal staff" rätt begrepp?
...
- Diagram/grafisk beskrivning av flödet. Var ska det ligga? Ska det alls med? 
...
## Hur paketera, organisera, sprida?
- Vilka är inblandade vid UMU, vilka kan tänkas vara intresserade och eventuellt ha förslag och synpunkter?
  ...
  - Forum/kanal för handledare?
  - Docentutbildning, Anne-Marie Fors Connolly
  - Biblioteket? Vem?
